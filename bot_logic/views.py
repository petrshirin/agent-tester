...
def inline_logic(c):
    ...
    router.add_route('theory?<int:test_num>/<int:page>/', action.start_theory)
    router.add_route('start_theory?<str:class_name>/', action.theory_menu)
    router.add_route('test?<str:name>/', action.test_menu)
    router.add_route('start_new_test?<int:test_num>/', action.start_test)
    router.add_route('start_test?<int:test_num>/<int:question_num>/', action.test)
    ...
    router.add_route('checkedquestion?<int:test_num>/<int:page>/', action.checked_question)
